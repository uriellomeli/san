...
san.ia <- san.ia %>% 
  rename(sleep.t = per_care_1, eat.t = per_care_2, cook.t = per_care_3, groom.t = per_care_4,
   ...
   mutate(sleep.w = if_else(sleep.w == 4, "Same time as weekdays", "Different time"),
         ...
         pc.w = if_else(tv.w == 3, "Same time as weekdays", "Different time"),
         radio.w = if_else(tv.w == 3, "Same time as weekdays", "Different time"),
         xbox.w = if_else(tv.w == 3, "Same time as weekdays", "Different time"),
         read.w = if_else(tv.w == 3, "Same time as weekdays", "Different time"),
         clean.w = if_else(tv.w == 3, "Same time as weekdays", "Different time"),
         wash.w = if_else(tv.w == 3, "Same time as weekdays", "Different time"),
         repair.w = if_else(tv.w == 3, "Same time as weekdays", "Different time"),
