...
load("~/GitHub/saetus/sa_survey.RData")
...
view(dfSummary(san[, 5:173], style = "grid", plain.ascii = F, graph.magnif = 2), method = "render")
```
...
view(dfSummary(sank[, 5:173], style = "grid", plain.ascii = F, graph.magnif = 2), method = "render")
```
