...
fig3 <- loss %>% 
  ...
  labs(y = NULL, x = NULL, color = NULL, size = NULL,
       ...
       caption = NULL) +
  theme_minimal() +
  themeuf + theme(legend.position = c(0.85, 0.1))
...
fig5 <- hardships %>% 
  ...
  labs(y = NULL, x = NULL, color = NULL,
       ...
       subtitle = NULL) +
  theme_minimal() +
  themeuf + theme(legend.position = c(0.85, 0.08), plot.subtitle = element_text(hjust = 0.5))
...
hardships.r %>% 
  ...
  labs(y = NULL, x = NULL, color = NULL,
       ...
       caption = NULL) +
  theme_minimal() +
  themeuf + theme(legend.position = c(.85, .1), strip.text = element_text(size = 27))
