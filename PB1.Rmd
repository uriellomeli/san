...
data.ec <- data %>% 
  filter(zipcode == "Elm Creek")

data.jh <- data %>% 
  filter(zipcode == "Jefferson Heights")
...
hardships.ec <- hardships %>% 
  filter(zipcode == "Elm Creek", hardships != "No difficulty")

hardships.jh <- hardships %>% 
  filter(zipcode == "Jefferson Heights", hardships != "No difficulty")
