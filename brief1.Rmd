...
lossxhealth2 %>% 
  ...
  facet_grid(~zipcode) +
  geom_text_repel(aes(label = label, x = ph.mean), size = 5, color = "gray30", nudge_x = .2, segment.alpha = 0) +
...
lossxhealth2 %>% 
  ...
  geom_point(aes(color = depen), size = 5, shape = 19) +
  facet_grid(~zipcode) +
  geom_text_repel(aes(label = label, x = mh.mean), size = 5, color = "gray30", nudge_x = .2, nudge_y = .2, segment.alpha = 0) +
  scale_color_igv(palette = "alternating") +
...
lossxbad2 %>% 
  ...
  geom_point(aes(color = depen), size = 5, shape = 19) +
  facet_grid(~zipcode) +
  geom_text(aes(label = label, x = ph.mean), size = 5, color = "gray30", nudge_y = .2) +
  scale_color_igv(palette = "alternating") +
...
lossxbad2 %>% 
  ...
  geom_point(aes(color = depen), size = 5, shape = 19) +
  facet_grid(~zipcode) +
  geom_text_repel(aes(label = label, x = mh.mean), size = 5, color = "gray30", nudge_y = .2, segment.alpha = 0) +
  scale_color_igv(palette = "alternating") +
