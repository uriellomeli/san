...
data %>% 
  ...
  geom_text_repel(aes(label = label, x = ph.mean), size = 7, color = "gray30", nudge_y = .15, segment.alpha = 0, family = "foo") +
  geom_text_repel(aes(label = label2, x = mh.mean), size = 7, color = "gray30", nudge_y = .15, segment.alpha = 0, family = "foo") +
