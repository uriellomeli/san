...
employed_pct %>%
  ...
  guides(color = guide_legend(label.position = "left", label.vjust = 0.5, label.hjust = 1)) +
  labs(y = NULL, x = NULL, color = NULL,
       title = "Employment Status: Employed by race and ethnicity", 
...
unemployed_pct %>%
  ...
  guides(color = guide_legend(label.position = "left", label.vjust = 0.5, label.hjust = 1)) +
  labs(y = NULL, x = NULL, color = NULL,
       title = "Employment Status: Unemployed by race and ethnicity", 
       subtitle = str_wrap("In the last seven days, what is your employment status"),
       caption = "Source: 2021 San Antonio Energy and Time Use Survey") +
  theme_classic() +
  themeuf
...
retired_pct %>%
  ...
  guides(color = guide_legend(label.position = "left", label.vjust = 0.5, label.hjust = 1)) +
  labs(y = NULL, x = NULL, color = NULL,
       title = "Employment Status: Retired by race and ethnicity", 
       subtitle = str_wrap("In the last seven days, what is your employment status"),
       caption = "Source: 2021 San Antonio Energy and Time Use Survey") +
  theme_classic() +
  themeuf
...
welfare <- welfare %>%
  group_by(zipcode, race_eth2) %>%
  summarize(average_welfare = mean(total_welfare))
...
welfare %>%
  ...
  guides(color = guide_legend(label.position = "left", label.vjust = 0.5, label.hjust = 1)) +
  labs(y = NULL, x = NULL, color = NULL,
       title = "Figure 3. Average Number of Types of Welfare by race and ethnicity", 
